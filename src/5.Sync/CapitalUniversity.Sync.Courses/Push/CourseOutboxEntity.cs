...
/// <summary>
/// Outbox row for Internal → External Courses push. Same shape as the Students/Staff
/// modules' outboxes — every push-enabled domain owns its own copy so the table
/// schemas can diverge per domain without coupling modules together. Shared
/// status/operation enums come from <see cref="OutboxStatus"/> / <see cref="OutboxOperation"/>.
/// </summary>
public sealed class CourseOutboxEntity
{
