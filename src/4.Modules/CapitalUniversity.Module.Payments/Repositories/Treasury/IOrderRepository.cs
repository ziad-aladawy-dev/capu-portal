...
public interface IOrderRepository
{
    ...
    Task<IReadOnlyList<Order>> GetForStudentAsync(Guid studentId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Order>> GetPendingPaymentOlderThanAsync(DateTime cutoffUtc, int maxCount, CancellationToken cancellationToken = default);
