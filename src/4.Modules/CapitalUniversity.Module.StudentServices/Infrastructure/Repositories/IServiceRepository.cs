...
public interface IServiceRepository
{
    ...
    Task<List<Service>> GetAvailableForStudentAsync(Guid studentId, string? studentNodePath, string? year, string? semester, CancellationToken cancellationToken = default);
