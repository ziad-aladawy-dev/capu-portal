...
{
    // Inline [Migration] + [DbContext] attributes — same hand-shipped pattern as the
    // earlier SessionVersion / Outbox migrations (no .Designer.cs sidecar).
    [DbContext(typeof(CoreDbContext))]
    [Migration("20260518000001_AddRefreshTokens")]
