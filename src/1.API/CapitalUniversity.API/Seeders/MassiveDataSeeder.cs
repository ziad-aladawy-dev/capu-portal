...
public static class MassiveDataSeeder
{
    ...
    private static async Task ExpandStudentsAsync(CoreDbContext context, IPasswordHasher passwordHasher)
    {
        ...
        string LocalizedName(string ar, string en) => LocalizedJson.Of(ar, en);
        ...
        void AddStudentsToProgram(string programName, int countPerLevel, Func<int, string, string> nameGen, Func<int, string> nidGen)
        {
            ...
            foreach (var level in progLevels)
            {
                for (var i = 1; i <= countPerLevel; i++)
                {
                    ...
                    var name = nameGen(i, suffix);
                    var nameJson = LocalizedName(name, name);
        ...
        AddStudentsToProgram("Computer & Systems Engineering", 3,
            (i, s) => s switch
            {
                "1-1" => "Ahmed Yasser Ali",
                "1-2" => "Mariam Tamer Hany",
                "1-3" => "Khaled Waleed Samir",
                "2-1" => "Nour Mohamed Essam",
                "2-2" => "Dina Ashraf Hassan",
                "2-3" => "Youssef Hani Khaled",
                "3-1" => "Sama Mostafa Adel",
                "3-2" => "Omar Sherif Galal",
                "3-3" => "Laila Mahmoud Nabil",
                _ => $"Student CSE {s}",
            },
        ...
        AddStudentsToProgram("Civil Engineering", 2,
            (i, s) => s switch
            {
                "1-1" => "Hassan Mohamed Ramadan",
                "1-2" => "Fatma Alaa El-Din",
                "2-1" => "Kareem Hassan Youssef",
                "2-2" => "Mona Gamal Abdou",
                "3-1" => "Mostafa Ahmed Shawky",
                "3-2" => "Hagar Adel Mahmoud",
                "4-1" => "Islam Tamer Mohamed",
                "4-2" => "Nourhan Said Hassan",
                _ => $"Student CE {s}",
            },
        ...
        AddStudentsToProgram("Architectural Engineering", 2,
            (i, s) => s switch
            {
                "1-1" => "Nada Khaled Omar",
                "1-2" => "Mohamed Ashraf Amin",
                "2-1" => "Sara Gamal El-Deen",
                "2-2" => "Ahmed Mahmoud Fathy",
                "3-1" => "Mariam Hany Sobhy",
                "3-2" => "Yassin Tarek Mohamed",
                "4-1" => "Noorhan Mostafa Kamel",
                "4-2" => "Ali Hassan Abdelaziz",
                _ => $"Student ARCH {s}",
            },
        ...
        AddStudentsToProgram("Mechanical Engineering", 2,
            (i, s) => s switch
            {
                "1-1" => "Mahmoud Ahmed Ibrahim",
                "1-2" => "Aya Elsayed Hassan",
                "2-1" => "Ibrahim Mostafa Gomaa",
                "2-2" => "Shaimaa Reda Ali",
                "3-1" => "Tamer Samir Waheed",
                "3-2" => "Heba Allah Mahmoud",
                "4-1" => "Mohamed Gamal Abdel-Fattah",
                "4-2" => "Amira Said Youssef",
                _ => $"Student ME {s}",
            },
        ...
        AddStudentsToProgram("Electrical Engineering", 2,
            (i, s) => s switch
            {
                "1-1" => "Ziad Hossam El-Din",
                "1-2" => "Reem Atef Mostafa",
                "2-1" => "Murad Walid Nabil",
                "2-2" => "Nada Ibrahim Abdel-Fattah",
                "3-1" => "Hussein Mohamed Nagy",
                "3-2" => "Salma Khaled Emam",
                "4-1" => "Yara Ahmed Mahmoud",
                "4-2" => "Mostafa Hany Shokry",
                _ => $"Student EE {s}",
            },
        ...
        AddStudentsToProgram("Clinical Nutrition", 2,
            (i, s) => s switch
            {
                "1-1" => "Asmaa Waleed Tawfik",
                "1-2" => "Mohamed Samy Abdelaziz",
                "2-1" => "Dalia Ashraf El-Sayed",
                "2-2" => "Hazem Mohamed Mohsen",
                "3-1" => "Eman Nabil Fouad",
                "3-2" => "Khaled Ahmed Abdel-Rahman",
                "4-1" => "Shorouk Mohamed Magdy",
                "4-2" => "Ahmed Hassan El-Gammal",
                _ => $"Student CN {s}",
            },
        ...
        AddStudentsToProgram("Nutrition & Food Science", 2,
            (i, s) => s switch
            {
                "1-1" => "Mai Tamer Hassan",
                "1-2" => "Abdel-Rahman Adel Nour",
                "2-1" => "Noha Khaled Ibrahim",
                "2-2" => "Tarek Yehia Mahmoud",
                "3-1" => "Rania Mostafa Kamal",
                "3-2" => "Hamza Ali Youssef",
                "4-1" => "Sohila Ahmed Mohamed",
                "4-2" => "Islam Said Khalil",
                _ => $"Student NFS {s}",
            },
        ...
        AddStudentsToProgram("Textile & Clothing", 2,
            (i, s) => s switch
            {
                "1-1" => "Rana Mohamed Alaa",
                "1-2" => "Adham Hassan Khaled",
                "2-1" => "Yasmin Khaled Abdel-Aziz",
                "2-2" => "Omar Ahmed Abdel-Maksoud",
                "3-1" => "Alaa El-Din Mostafa",
                "3-2" => "Hana Ibrahim Mahmoud",
                "4-1" => "Samar Gamal El-Deen",
                "4-2" => "Maged Waleed Hany",
                _ => $"Student TEX {s}",
            },
        ...
        AddStudentsToProgram("Biomedical Engineering", 2,
            (i, s) => s switch
            {
                "1-1" => "Lamia Ashraf Hassan",
                "1-2" => "Omar Hany Galal",
                "2-1" => "Nourhan Essam Mohamed",
                "2-2" => "Seif El-Din Khaled",
                "3-1" => "Shahd Mahmoud Ibrahim",
                "3-2" => "Amr Abdel-Halim Saad",
                "4-1" => "Farah Waleed Mostafa",
                "4-2" => "Mohanad Yasser Osman",
                _ => $"Student BME {s}",
            },
        ...
        AddStudentsToProgram("Communications & Information Engineering", 2,
            (i, s) => s switch
            {
                "1-1" => "Mariam Hossam El-Din",
                "1-2" => "Abdullah Mohamed Kamel",
                "2-1" => "Sara Ahmed El-Sherif",
                "2-2" => "Mohamed Nagy Abdel-Monem",
                "3-1" => "Hala Said Ibrahim",
                "3-2" => "Karim Emad El-Din",
                "4-1" => "Nabila Yasser Farouk",
                "4-2" => "Youssef Ahmed Abdel-Hamid",
                _ => $"Student CIE {s}",
            },
        ...
        AddStudentsToProgram("Family & Childhood Institution Management", 2,
            (i, s) => s switch
            {
                "1-1" => "Shimaa Ali Abdel-Aziz",
                "1-2" => "Moustafa Gamal Rabie",
                "2-1" => "Marwa Hani Mahmoud",
                "2-2" => "Islam Abdel-Nasser",
                "3-1" => "Aisha Tamer Abdou",
                "3-2" => "Mohamed Khairy Abdel-Wahab",
                "4-1" => "Rasha Emad Hassan",
                "4-2" => "Ibrahim Shaaban Mohamed",
                _ => $"Student FC {s}",
            },
        ...
        AddStudentsToProgram("General Stream", 2,
            (i, s) => s switch
            {
                "1-1" => "Hasnaa Magdy Ahmed",
                "1-2" => "Alaa El-Din Mohamed",
                "2-1" => "Ebtisam Khaled Hassan",
                "2-2" => "Mohamed Reda Ali",
                "3-1" => "Hanan Abdel-Aziz",
                "3-2" => "Ahmed Sobhy Mahmoud",
                "4-1" => "Safaa Nabil Ibrahim",
                "4-2" => "Khalid Yasser Omar",
                _ => $"Student GS {s}",
            },
    ...
    private static async Task ExpandStaffAsync(CoreDbContext context, IPasswordHasher passwordHasher)
    {
        ...
        for (var i = 0; i < defs.Length; i++)
        {
            ...
            var nameJson = LocalizedJson.Of(d.Name, d.Name);
    ...
    // ════════════════════════════════════════════════════════════════
    //  ACADEMIC HISTORY (Registrations, Results, GPA)
    // ════════════════════════════════════════════════════════════════
        ...
        foreach (var student in students)
        {
            ...
            for (var lvl = 1; lvl <= levelIdx; lvl++)
            {
                             ...
                             .OrderBy(p => p.Semester).ThenBy(p => p.CourseId))
                {
                    ...
                    if (!attempts.Add(course.Id)) continue;
                    ...
                    else
                    {
                        ...
                        var (letter, points, score) = PickGrade(2, 7);
    ...
    // ════════════════════════════════════════════════════════════════
    //  PORTAL PROFILE RECORDS (Contact & Emergency)
    // ════════════════════════════════════════════════════════════════
    ...
    private static async Task SeedStudentNotificationsAsync(CoreDbContext context)
    {
        ...
        void Notify(Guid recipient, string arTitle, string enTitle, string arMsg, string enMsg,
            NotificationType type, bool isRead, DateTime createdAt)
        {
            context.Notifications.Add(new Notification
            {
                ...
                Title = LocalizedJson.Of(arTitle, enTitle),
        ...
        foreach (var student in students)
        {
            var firstName = student.Name.Contains("ar") ? "طالب" : student.Name.Split(' ')[0];
    ...
    private static async Task SeedPortalServicesAsync(IServiceProvider serviceProvider)
    {
        ...
        Workflow MakeWorkflow(string nameAr, string nameEn, bool paid, params (string LabelAr, string LabelEn, StepFieldType Type, bool Required, string? Options)[] fields)
        {
            var steps = new List<WorkflowStep>
            {
                ...
                {
                    Order = 1,
                    Title = LocalizedJson.Of("بيانات الطلب", "Request Data"),
                    Description = LocalizedJson.Of("استكمل بيانات الطلب المطلوبة", "Complete the required request data"),
                    StepType = WorkflowStepType.Form,
                    IsRequired = true,
                    Fields = fields.Select((f, i) => new WorkflowStepField
                    {
                        Order = i + 1,
                        Label = LocalizedJson.Of(f.LabelAr, f.LabelEn),
                        FieldType = f.Type,
            ...
            if (paid)
            {
                ...
                {
                    Order = next++,
                    Title = LocalizedJson.Of("سداد الرسوم", "Payment"),
                    Description = LocalizedJson.Of("سداد رسوم الخدمة إلكترونياً", "Pay service fee electronically"),
            ...
            {
                Order = next,
                Title = LocalizedJson.Of("مراجعة واعتماد", "Review & Approval"),
                Description = LocalizedJson.Of("مراجعة الطلب من الموظف المختص", "Review by the assigned staff"),
                StepType = WorkflowStepType.Review,
                IsRequired = true,
            });
            return new Workflow { Name = LocalizedJson.Of($"سير عمل {nameAr}", $"Workflow {nameEn}"), Steps = steps };
        }

        async Task AddServiceAsync(string nameAr, string nameEn, string descAr, string descEn,
            ServiceType type, bool paid, decimal price,
            Workflow workflow, params StructureNode[] scopeNodes)
        {
            ...
            {
                Name = LocalizedJson.Of(nameAr, nameEn),
                Description = LocalizedJson.Of(descAr, descEn),
                Type = type,
                IsActive = true,
                IsPaid = paid,
        ...
        await AddServiceAsync(
            "طلب بيان درجات رسمي", "Official Transcript Request",
            "إصدار بيان درجات رسمي معتمد بجميع المقررات والتقديرات الحاصل عليها الطالب.",
            "Issue an official certified transcript with all courses and grades.",
            ServiceType.Administrative, true, 150m,
            MakeWorkflow("بيان درجات", "Transcript", true,
                ("عدد النسخ", "Number of Copies", StepFieldType.Select, true, copiesOptions),
                ("اللغة", "Language", StepFieldType.Select, true, languageOptions),
                ("الغرض من الطلب", "Purpose", StepFieldType.TextArea, false, null)),
            root);

        await AddServiceAsync(
            "شهادة قيد", "Enrollment Certificate",
            "إصدار شهادة قيد رسمية تفيد انتظام الطالب بالدراسة في العام الجامعي الحالي.",
            "Issue an official enrollment certificate confirming the student's active status in the current academic year.",
            ServiceType.Administrative, true, 75m,
            MakeWorkflow("شهادة قيد", "Enrollment Cert", true,
                ("الجهة الموجهة إليها الشهادة", "Recipient", StepFieldType.Text, true, null),
                ("اللغة", "Language", StepFieldType.Select, true, languageOptions)),
            root);

        await AddServiceAsync(
            "بدل فاقد كارنيه الطالب", "Student ID Card Replacement",
            "إصدار كارنيه بديل في حالة الفقد أو التلف.",
            "Issue a replacement student ID card in case of loss or damage.",
            ServiceType.General, true, 85m,
            MakeWorkflow("بدل كارنيه", "ID Replacement", true,
                ("سبب الاستخراج", "Reason", StepFieldType.Select, true, JsonSerializer.Serialize(new[] { "فقد", "تلف", "تغيير بيانات" })),
                ("ملاحظات", "Notes", StepFieldType.TextArea, false, null)),
            root);

        await AddServiceAsync(
            "طلب إيقاف قيد / تأجيل", "Leave of Absence / Deferral",
            "تقديم طلب إيقاف قيد أو تأجيل الدراسة لفصل دراسي أو عام كامل وفقاً للائحة.",
            "Submit a request to stop enrollment or defer studies for a semester or full year per regulations.",
            ServiceType.Administrative, false, 0m,
            MakeWorkflow("إيقاف قيد", "Deferral", false,
                ("نوع الإيقاف", "Type", StepFieldType.Select, true, JsonSerializer.Serialize(new[] { "فصل دراسي", "عام كامل" })),
                ("السبب", "Reason", StepFieldType.Select, true, reasonOptions),
                ("تفاصيل إضافية", "Details", StepFieldType.TextArea, true, null)),
            root);

        await AddServiceAsync(
            "تظلم من نتيجة مقرر", "Grade Appeal",
            "تقديم تظلم رسمي لإعادة رصد أو مراجعة درجة مقرر دراسي.",
            "Submit a formal appeal to re-evaluate or review a course grade.",
            ServiceType.Specialized, false, 0m,
            MakeWorkflow("تظلم", "Appeal", false,
                ("كود المقرر", "Course Code", StepFieldType.Text, true, null),
                ("الفصل الدراسي", "Semester", StepFieldType.Text, true, null),
                ("أسباب التظلم", "Reasons", StepFieldType.TextArea, true, null)),
            root);

        await AddServiceAsync(
            "طلب انسحاب من مقرر", "Course Withdrawal",
            "الانسحاب من مقرر دراسي خلال الفترة المسموح بها دون احتساب رسوب.",
            "Withdraw from a course within the allowed period without failing grade.",
            ServiceType.General, false, 0m,
            MakeWorkflow("انسحاب", "Withdrawal", false,
                ("كود المقرر", "Course Code", StepFieldType.Text, true, null),
                ("سبب الانسحاب", "Reason", StepFieldType.TextArea, true, null)),
            root);
        ...
        foreach (var faculty in faculties.Values)
        {
            ...
            if (isEngineering)
            {
                await AddServiceAsync(
                    ...
                    $"Internship Letter - {faculty.Name}",
                    "إصدار خطاب رسمي موجه لجهة التدريب الميداني الصيفي.",
                    "Issue an official letter addressed to the summer field training entity.",
                    ServiceType.Specialized, true, 200m,
                    MakeWorkflow("خطاب تدريب", "Internship Letter", true,
                        ("اسم جهة التدريب", "Entity Name", StepFieldType.Text, true, null),
                        ("مدة التدريب", "Duration", StepFieldType.Select, true, JsonSerializer.Serialize(new[] { "شهر", "شهران", "ثلاثة أشهر" })),
                        ("تاريخ بدء التدريب", "Start Date", StepFieldType.Date, true, null)),
                    faculty);
            }
            else
            {
                await AddServiceAsync(
                    ...
                    $"Lab Booking - {faculty.Name}",
                    "حجز معامل الكلية لإجراء التجارب والمشروعات البحثية خارج مواعيد المحاضرات.",
                    "Reserve faculty labs for experiments and research projects outside lecture hours.",
                    ServiceType.Specialized, false, 0m,
                    MakeWorkflow("حجز معمل", "Lab Booking", false,
                        ("المعمل المطلوب", "Lab Name", StepFieldType.Text, true, null),
                        ("التاريخ المطلوب", "Date", StepFieldType.Date, true, null),
                        ("الغرض", "Purpose", StepFieldType.TextArea, true, null)),
                    faculty);
            }
        }
