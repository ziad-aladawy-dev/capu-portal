...
const QUICK_PAGES = [
  ...
  { title: "Course Catalog", path: "/admin/academic/courses", type: "page" },
  { title: "Academic Plans", path: "/admin/academic/plans", type: "page" },
  { title: "Programs", path: "/admin/academic/programs", type: "page" },
  ...
  { title: "Course Offerings", path: "/admin/academic/offerings", type: "page" },
  ...
  { title: "Treasury Collections", path: "/admin/finance/treasury", type: "page" },
  { title: "Billing Setup", path: "/admin/finance/billing-setup", type: "page" },
