...
import { Menu, User, Mail, Lock, Phone, Shield, CheckCircle2, ArrowLeft, UserPlus, Bell, Moon, KeyRound, Building2, Briefcase } from 'lucide-react';
...
const AddStaff = () => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (universitiesData.length > 0) {
          setFormData(prev => ({ ...prev, universityId: universitiesData[0].id }));
        }
      } catch (error) {
  ...
  // Generate staff code when university changes
  useEffect(() => {
    const generateCode = async () => {
      if (formData.universityId) {
        try {
          ...
          console.log('Generated staff code:', result.staffCode);
        } catch (error) {
          console.error('Error generating staff code:', error);
          // Fallback code
          const fallbackCode = `STAFF${Date.now()}`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Use generated staff code
      const staffCode = generatedCode || `STAFF${Date.now()}`;
      ...
      const staffData = {
        ...
        staffCode: staffCode,  // ← مهم جداً: نبعت الـ staff code
    ...
    <div className="add-user-page">
      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-title-wrapper h3 { font-size: 12px; font-weight: 700; color: var(--gold-light); font-family: 'Space Mono', monospace; text-transform: uppercase; letter-spacing: 0.8px; }
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="form-body">
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <div className="input-wrapper">
                    <input type="email" name="email" className={`form-input ${errors.email ? 'error' : ''}`} placeholder="staff@university.edu" value={formData.email} onChange={handleChange} />
            ...
            <div className="form-body">
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <div className="input-wrapper">
                    <select name="staffRoleId" className={`form-select ${errors.staffRoleId ? 'error' : ''}`} value={formData.staffRoleId} onChange={handleChange}>
                ...
                <div className="form-group">
                  ...
                  <div className="input-wrapper">
                    <select name="universityId" className={`form-select ${errors.universityId ? 'error' : ''}`} value={formData.universityId} onChange={handleChange}>
                ...
                <div className="form-group">
                  <label className="form-label">Staff Code (Auto-generated)</label>
                  <div className="code-display">
                    {generatedCode || 'Select university to generate code'}
                  </div>
                  <span className="input-hint">Staff code will be auto-generated based on university</span>
                </div>

                <div className="form-group">
                  <label className="form-label">Position</label>
                  <div className="input-wrapper">
                    <input type="text" name="position" className="form-input" placeholder="e.g., Department Head" value={formData.position} onChange={handleChange} />
          ...
          <div className="submit-section">
            <button type="submit" className="submit-button" disabled={submitting}>
              {submitting ? <><div className="button-spinner"></div> Creating Staff...</> : <><UserPlus size={20} /> Create Staff Account</>}
            </button>
          </div>
        </form>
      </div>
