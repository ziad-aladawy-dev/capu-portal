...
public class PermissionTreeBenchmarkTests : IClassFixture<WebApplicationFactory<ModulesRegistry>>
{
        ...
        _factory = factory.WithWebHostBuilder(builder =>
        {
            ...
            builder.ConfigureTestServices(services =>
            {
                ...
                services.AddDbContext<CoreDbContext>(options => 
                    options.UseSqlServer("Server=localhost,1433;Database=CapitalUniversityDb;User Id=SA;Password=CUP_Str0ng!Pass;TrustServerCertificate=True;MultipleActiveResultSets=true",
    ...
    public async Task Benchmark_GetUserPermissionTree()
    {
        ...
        using (var scope = _factory.Services.CreateScope())
        {
            ...
            // Ensure DB is created/migrated for the real SQL connection
            ...
            db.AddCrudGrant(adminRole.Id, adminResource.Id, ActionLevel.EditClose); 
